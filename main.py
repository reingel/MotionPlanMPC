...
# contact constraints
hull_gap = fmin(
    yh + robot.Lh*sin(-thh) - robot.Hh*cos(-thh) - road_height(xh),
    yh - robot.Lh*sin(-thh) - robot.Hh*cos(-thh) - road_height(xh),
)
...
M = -(wheel1_x_wrt_hull*force_wh1 + wheel2_x_wrt_hull*force_wh2 + wheel3_x_wrt_hull*force_wh3)
opti.subject_to((Fy - Wr)**2 < 0.1)
opti.subject_to(M**2 < 0.1)
